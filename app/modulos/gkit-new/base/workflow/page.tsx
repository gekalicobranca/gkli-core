...
export default async function GkitNewWorkflowPage({
  ...
  const context = await requireGkitNewContext(moduleTarget('/modulos/gkli-new/base/workflow', params))
  ...
  return (
    <GkitNewShell
      ...
      actions={canWrite ? <Link className="button" href="/modulos/gkli-new/base/workflow/novo">Novo modelo</Link> : null}
    >
      ...
      <GkitNewSection title="Modelos de tarefa" description="Cada modelo define descricao, dias e responsavel padrao.">
        <GkitNewFilterBar
          ...
          resetHref="/modulos/gkli-new/base/workflow"
