...
export default async function GkitNewClientesPage({
  ...
  const context = await requireGkitNewContext(moduleTarget('/modulos/gkli-new/clientes', params))
  ...
  return (
    <GkitNewShell
      ...
      actions={canWrite ? <Link className="button" href="/modulos/gkli-new/clientes/novo">Novo cliente</Link> : null}
    >
      ...
      <GkitNewSection title="Base de clientes" description="Status derivado automaticamente por oportunidade aprovada.">
        <GkitNewFilterBar
          ...
          resetHref="/modulos/gkli-new/clientes"
