...
export default async function GkitNewContatosPage({
  ...
  const context = await requireGkitNewContext(moduleTarget('/modulos/gkli-new/contatos', params))
  ...
  return (
    <GkitNewShell
      ...
      actions={canWrite ? <Link className="button" href="/modulos/gkli-new/contatos/novo">Novo contato</Link> : null}
    >
      ...
      <GkitNewSection title="Base de contatos" description="Contato x cliente em relacao N para N.">
        <GkitNewFilterBar
          ...
          resetHref="/modulos/gkli-new/contatos"
