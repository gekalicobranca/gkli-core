...
export default async function GkitNewPage({
  ...
  const context = await requireGkitNewContext(moduleTarget('/modulos/gkli-new', params))
  ...
  return (
    <GkitNewShell
      ...
      description="Execucao diaria do GKLI New, organizada na ordem natural do trabalho comercial."
