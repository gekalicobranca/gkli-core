...
export default async function GkitNewOportunidadesPage({
  ...
  const context = await requireGkitNewContext(moduleTarget('/modulos/gkli-new/oportunidades', params))
  ...
  return (
    <GkitNewShell
      ...
      actions={canWrite ? <Link className="button" href="/modulos/gkli-new/oportunidades/novo">Nova oportunidade</Link> : null}
    >
      ...
      <GkitNewSection title="Pipeline operacional" description="Aprovada ativa o cliente; encerrada finaliza a negociacao.">
        <GkitNewFilterBar
          ...
          resetHref="/modulos/gkli-new/oportunidades"
