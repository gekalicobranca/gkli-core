...
export default async function GkitAtePage({
  ...
  const context = await requireGkitAteContext(moduleTarget('/modulos/gkli-ate', params))
  ...
  return (
    <GkitAteShell
      ...
      description="Execucao diaria do GKLI ATE, organizada na ordem natural do atendimento consultivo."
