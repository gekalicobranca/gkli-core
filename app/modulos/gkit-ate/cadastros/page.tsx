...
export default async function GkitAteCadastrosPage({
  ...
  const context = await requireGkitAteContext(moduleTarget('/modulos/gkli-ate/cadastros', params))
  ...
  const tabHref = (tab: 'atendimentos' | 'tarefas') => {
    ...
    return `/modulos/gkli-ate/cadastros?${query.toString()}`
  }
    ...
    >
      ...
      <GkitAteSection title="Listas de cadastro" description="Tipos separados em abas para consulta e manutencao operacional.">
        ...
        <GkitAteFilterBar
          ...
          resetHref={`/modulos/gkli-ate/cadastros?tab=${filters.tab}`}
