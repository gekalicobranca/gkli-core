...
const activeHref: Record<GkitAteTab, string> = {
  cockpit: '/modulos/gkli-ate',
  atendimentos: '/modulos/gkli-ate/atendimentos',
  tarefas: '/modulos/gkli-ate/tarefas',
  importacoes: '/modulos/gkli-ate/importacoes',
  cadastros: '/modulos/gkli-ate/cadastros',
}

const navGroups: ModuleNavGroup[] = [
  { href: '/modulos/gkli-ate', title: 'Cockpit' },
  { href: '/modulos/gkli-ate/atendimentos', title: 'Atendimentos' },
  { href: '/modulos/gkli-ate/tarefas', title: 'Tarefas' },
  { href: '/modulos/gkli-ate/importacoes', title: 'Importacoes' },
  { href: '/modulos/gkli-ate/cadastros', title: 'Cadastros' },
]
      ...
      <section className="card module-form module-form-wide">
        ...
        <GkitAteList
          ...
          rows={atendimento.tarefas.map((tarefa) => ({
            ...
            meta: tarefa.origem,
            detailHref: `/modulos/gkli-ate/tarefas/${tarefa.id}`,
  ...
  return (
    <section className="card module-form">
      ...
      <div className="form-actions">
        ...
        <Link className="button secondary" href={`/modulos/gkli-ate/atendimentos/${tarefa.atendimento_id}`}>Ver atendimento</Link>
        <Link className="button secondary" href="/modulos/gkli-ate/tarefas">Voltar</Link>
      </div>
