...
const navItems = [
  { href: '/modulos/gkli-flex', label: 'Cockpit' },
  { href: '/modulos/gkli-flex/previsoes', label: 'Previsoes' },
  { href: '/modulos/gkli-flex/receitas', label: 'Receitas' },
  { href: '/modulos/gkli-flex/pagamentos', label: 'Pagamentos' },
  { href: '/modulos/gkli-flex/saneamento', label: 'Saneamento' },
  { href: '/modulos/gkli-flex/colaboradores', label: 'Colaboradores' },
  { href: '/modulos/gkli-flex/comissoes', label: 'Comiss\u00f5es' },
  { href: '/modulos/gkli-flex/cadastros', label: 'Cadastros' },
  { href: '/modulos/gkli-flex/auditoria', label: 'Auditoria' },
];

function isActive(pathname: string, href: string) {
  if (href === '/modulos/gkli-flex') return pathname === href;
  ...
  return (
    <main className="module-shell gkit-flex-shell gkit-flex-operational-shell">
      <aside className="module-sidebar gkit-flex-sidebar">
        <Link className="module-sidebar-header gkit-flex-sidebar-header" href={withCompetencia('/modulos/gkli-flex', competencia)}>
          <BrandLogo className="module-sidebar-mark gkit-flex-sidebar-mark" label="Gestao mensal" />
          <div>
            <strong>GKLI Flex</strong>
            <small>Gestao mensal</small>
          </div>
        </Link>

        <nav aria-label="Navegacao GKLI Flex">
          {navItems.map((item) => (
