    ...
    <main className="page-shell wide-shell">
      <section className="month-context-header">
        <div className="month-context-main">
          <p className="eyebrow">GKLI Flex</p>
          <h1>Colaboradores</h1>
        ...
        {canWrite ? (
          <div className="month-context-side">
            <Link className="primary-button" href="/modulos/gkli-flex/colaboradores/novo">Novo colaborador</Link>
          </div>
        ) : null}
      </section>
      ...
      <section className="card">
        <div className="header-row compact-header">
          ...
          <form className="gkit-flex-filters" action="/modulos/gkli-flex/colaboradores">
        ...
        {rows.length ? (
                ...
                {rows.map((row) => (
                  <tr key={row.id}>
                    ...
                    <td className="text-right">
                      {canWrite ? <Link className="secondary-button" href={`/modulos/gkli-flex/colaboradores/${row.id}`}>Editar</Link> : null}
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          <EmptyState
            ...
            action={canWrite ? <Link className="primary-button" href="/modulos/gkli-flex/colaboradores/novo">Novo colaborador</Link> : null}
          />
        )}
      </section>
    </main>
  ...
  return (
    <main className="page-shell wide-shell">
      <section className="month-context-header">
        ...
        <div className="month-context-side">
          <Link className="secondary-button" href="/modulos/gkli-flex/colaboradores">Voltar</Link>
        </div>
      </section>
      ...
      <form className="card gkit-flex-form" action={action}>
        ...
        <div className="actions">
          <Link className="secondary-button" href="/modulos/gkli-flex/colaboradores">Cancelar</Link>
