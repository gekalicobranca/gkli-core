        ...
        {active === 'comparativo' ? (
          <>
            <div className="header-row compact-header">
              ...
              <a className="secondary-button" href={`/modulos/gkli-flex/previsoes?competencia=${competenciaParam}`}>Abrir previsoes</a>
            </div>
            <section className="grid-3 dashboard-metrics">
        ...
        {active === 'colaboradores' ? (
          <>
            <div className="header-row compact-header">
              ...
              <a className="secondary-button" href="/modulos/gkli-flex/colaboradores">Abrir colaboradores</a>
            </div>
            <section className="grid-3 dashboard-metrics">
