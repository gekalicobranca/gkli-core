  ...
  if (!data.collaborator) {
    return (
      <section className="suite-empty-card">
        ...
        <span>O acesso ao Colab esta liberado no Core, mas o e-mail do usuario ainda nao tem cadastro ativo no GKLI Flex.</span>
      </section>
    )
  }
    ...
    return (
      <section className="card suite-panel">
        <div className="suite-panel-heading">
          <div>
            <h2>Pendencias</h2>
          <p>Vinculo do colaborador no GKLI Flex.</p>
          </div>
        </div>
        <div className="suite-empty-block warning">
          <strong>Cadastro nao localizado</strong>
          <span>Seu acesso ao Colab esta ativo, mas o cadastro de colaborador ainda nao foi encontrado no GKLI Flex.</span>
        </div>
      </section>
    )
  }
  ...
  return (
    <section className="card suite-panel">
      <div className="suite-panel-heading">
        <div>
          <h2>Pendencias</h2>
          <p>Itens publicados pelo GKLI Flex para acompanhamento individual.</p>
        </div>
      </div>
      {actions.length ? (
  ...
  const modules = [
    {
      ...
      title: 'Perfil',
      description: data.collaborator ? `${data.collaborator.role} - ${data.collaborator.department}` : 'Cadastro pendente no GKLI Flex',
    ...
    },
    {
      ...
      title: 'Pagamentos',
      description: 'Demonstrativos vindos do GKLI Flex',
    ...
    },
    {
      ...
      title: 'Beneficios',
      description: 'Beneficios cadastrados no GKLI Flex',
  ...
  return (
    <section className="card suite-panel">
      <div className="suite-panel-heading">
        <div>
          <h2>Pagamentos</h2>
          <p>Demonstrativos financeiros derivados do GKLI Flex.</p>
        </div>
      </div>
...
export function ColabBenefits({ data }: { data: ColabData }) {
  return (
    <section className="suite-module-grid">
      ...
      {!data.benefits.length ? <EmptyBlock label="Nenhum beneficio cadastrado no GKLI Flex." /> : null}
    </section>
  )
}
  ...
  if (!collaborator) {
    return (
      <section className="suite-empty-card">
        ...
        <span>O e-mail do usuario ainda nao tem cadastro ativo no GKLI Flex.</span>
      </section>
    )
  }
