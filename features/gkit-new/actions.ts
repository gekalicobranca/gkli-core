...
async function requireGkitNewWrite(permission: string) {
  const context = await requireModuleAccess('gkli-new')
  if (!canAccess(context.permissions, permission)) {
    throw new Error('Usuário sem permissão para executar esta ação no GKLI New.')
  }
  return context
}
...
function revalidateGkitNewBase(id?: string, kind?: 'cliente' | 'contato' | 'workflow' | 'oportunidade' | 'tarefa') {
  revalidatePath('/modulos/gkli-new')
  revalidatePath('/modulos/gkli-new/clientes')
  revalidatePath('/modulos/gkli-new/contatos')
  revalidatePath('/modulos/gkli-new/oportunidades')
  revalidatePath('/modulos/gkli-new/tarefas')
  revalidatePath('/modulos/gkli-new/gestao')
  revalidatePath('/modulos/gkli-new/base/workflow')
  if (id && kind === 'cliente') revalidatePath(`/modulos/gkli-new/clientes/${id}`)
  if (id && kind === 'contato') revalidatePath(`/modulos/gkli-new/contatos/${id}`)
  if (id && kind === 'workflow') revalidatePath(`/modulos/gkli-new/base/workflow/${id}`)
  if (id && kind === 'oportunidade') revalidatePath(`/modulos/gkli-new/oportunidades/${id}`)
  if (id && kind === 'tarefa') revalidatePath(`/modulos/gkli-new/tarefas/${id}`)
}
...
export async function createGkitNewClienteAction(formData: FormData) {
  ...
  redirect(`/modulos/gkli-new/clientes/${data.id}`)
}
...
export async function updateGkitNewClienteAction(formData: FormData) {
  ...
  redirect('/modulos/gkli-new/clientes')
}
...
export async function createGkitNewContatoAction(formData: FormData) {
  ...
  redirect(`/modulos/gkli-new/contatos/${data.id}`)
}
...
export async function updateGkitNewContatoAction(formData: FormData) {
  ...
  redirect('/modulos/gkli-new/contatos')
}
...
export async function createGkitNewWorkflowAction(formData: FormData) {
  ...
  redirect(`/modulos/gkli-new/base/workflow/${data.id}`)
}
...
export async function updateGkitNewWorkflowAction(formData: FormData) {
  ...
  redirect('/modulos/gkli-new/base/workflow')
}
...
export async function createGkitNewOportunidadeAction(formData: FormData) {
  ...
  redirect(`/modulos/gkli-new/oportunidades/${oportunidadeId}`)
}
...
export async function createGkitNewCockpitPropostaAction(formData: FormData) {
  ...
  revalidateGkitNewBase(oportunidadeId, 'oportunidade')
  redirect('/modulos/gkli-new?painel=acompanhamento')
}
...
export async function updateGkitNewOportunidadeAction(formData: FormData) {
  ...
  redirect('/modulos/gkli-new/oportunidades')
}
...
export async function completeGkitNewTarefaAction(formData: FormData) {
  ...
  redirect('/modulos/gkli-new/tarefas')
}
