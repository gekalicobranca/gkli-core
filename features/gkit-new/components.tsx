...
const activeHref: Record<GkitNewTab, string> = {
  cockpit: '/modulos/gkli-new',
  clientes: '/modulos/gkli-new/clientes',
  contatos: '/modulos/gkli-new/contatos',
  oportunidades: '/modulos/gkli-new/oportunidades',
  workflow: '/modulos/gkli-new/base/workflow',
  gestao: '/modulos/gkli-new/gestao',
  tarefas: '/modulos/gkli-new/tarefas',
}

const navGroups: ModuleNavGroup[] = [
  { href: '/modulos/gkli-new', title: 'Cockpit' },
  { href: '/modulos/gkli-new/clientes', title: 'Clientes' },
  { href: '/modulos/gkli-new/contatos', title: 'Contatos' },
  { href: '/modulos/gkli-new/oportunidades', title: 'Oportunidades' },
  { href: '/modulos/gkli-new/base/workflow', title: 'Workflow' },
  { href: '/modulos/gkli-new/tarefas', title: 'Tarefas' },
  { href: '/modulos/gkli-new/gestao', title: 'Dashboard' },
]
  ...
  return (
    <form action={action} className="card module-form module-form-grid">
      ...
      <div className="form-actions module-form-wide">
        ...
        <Link className="button secondary" href="/modulos/gkli-new/clientes">Cancelar</Link>
      </div>
    </form>
  )
}
  ...
  return (
    <form action={action} className="card module-form module-form-grid">
      ...
      <div className="form-actions module-form-wide">
        ...
        <Link className="button secondary" href="/modulos/gkli-new/contatos">Cancelar</Link>
      </div>
    </form>
  )
}
  ...
  return (
    <form action={action} className="card module-form module-form-grid">
      ...
      <div className="form-actions module-form-wide">
        ...
        <Link className="button secondary" href="/modulos/gkli-new/base/workflow">Cancelar</Link>
      </div>
    </form>
  )
}
  ...
  return (
    <section className="card module-form">
      ...
      <div className="form-actions">
        ...
        <Link className="button secondary" href="/modulos/gkli-new/tarefas">Voltar</Link>
      </div>
    </section>
  )
}
